...
public abstract class WeaponBuilder {
	...
	public static Weapon buildWeapon(TypeWeapon type, int team){
		switch(type){
		case SWORD:
			return new Weapon(type, 1, 3, 5, true, 1, null, team, Art.swordProjectile, Art.swordButton);
		case BATTLEAXE:
			return new Weapon(type, 2, 2, 10, true, 2, null, team, Art.swordProjectile, Art.battleaxeButton);
		case MACE:
			return new Weapon(type, 3, 2, 15, true, 3, null, team, Art.swordProjectile, Art.maceButton);
		case CROSSBOW:
			return new Weapon(type, 3, 3, 10, false, 1, null, team, Art.arrow, Art.crossbowButton);
		case BOW:
			return new Weapon(type, 2, 2, 5, false, 1, null, team, Art.arrow, Art.bowButton);
		case FIRE_STAFF:
