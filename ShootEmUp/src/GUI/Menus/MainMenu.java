...
public class MainMenu extends GuiMenu {
    ...
    public MainMenu(Image menuImage) {
        super(menuImage);
        selectedItem = 0;
        newGame = addButton(new Button(Art.newGameButton, (ShootEmUp.WIDTH / 2) - (Art.newGameButton.getWidth() / 2), (ShootEmUp.HEIGHT / 2) - Art.newGameButton.getHeight(), 128,24));
        exit = addButton(new Button(Art.exitButton,  (ShootEmUp.WIDTH /  2) - (Art.exitButton.getWidth() / 2), (ShootEmUp.HEIGHT / 2), 128,24));
    }
