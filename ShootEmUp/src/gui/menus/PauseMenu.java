...
public abstract class PauseMenu extends GuiMenu {
	...
	public PauseMenu(Image MenuImage) {
		...
		ButtonList tabs = new ButtonList(922, 0, Art.getImage("SkillButton").getHeight() / 2, 0);
		...
		ButtonList nativeButtons = new ButtonList(30, ShootEmUp.height - 94, Art.getImage("ExitButton").getHeight() / 2,
				20);
