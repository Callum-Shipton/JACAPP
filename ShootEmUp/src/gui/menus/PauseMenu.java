...
public abstract class PauseMenu extends GuiMenu {
	...
	public void resetMenu() {
		...
		tabs.addMenuItem(new Button(ImageProcessor.getImage("InvButton"),
				new OpenMenuButton(new InventoryMenu(ImageProcessor.getImage("InventoryScreen")))));
		tabs.addMenuItem(new Button(ImageProcessor.getImage("SkillButton"),
				new OpenMenuButton(new SkillMenu(ImageProcessor.getImage("SkillScreen")))));
		tabs.addMenuItem(new Button(ImageProcessor.getImage("UpgradesButton"),
				new OpenMenuButton(new UpgradesMenu(ImageProcessor.getImage("UpgradesScreen")))));
		tabs.addMenuItem(new Button(ImageProcessor.getImage("MapButton"),
				new OpenMenuButton(new MapMenu(ImageProcessor.getImage("MapScreen")))));
		tabs.addMenuItem(new Button(ImageProcessor.getImage("SaveButton"),
		...
		nativeButtons.addMenuItem(new Button(ImageProcessor.getImage("BackButton"), new ResumeButton()));
		nativeButtons.addMenuItem(new Button(ImageProcessor.getImage("ExitButton"), new ExitButton()));
