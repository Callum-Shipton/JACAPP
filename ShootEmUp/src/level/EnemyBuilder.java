...
public final class EnemyBuilder {
	...
	public static Entity buildEnemy(TypeEnemy type) {
		...
		case SMALL:
			...
			enemyAttack = new EnemyAttack(1, 5, "OneHanded",0, null, null, null, null, null);
			break;
		case NORMAL:
			Logger.debug("Enemy Spawn", Logger.Category.ENTITIES);
			addComponents("Enemy", 4);
			enemyAttack = new EnemyAttack(3, 5, "Bow",0, null, null, null, null, null);
			break;
		case FLYING:
			Logger.debug("Flying Enemy Spawn", Logger.Category.ENTITIES);
			addComponents("FlyingEnemy", 5);
			enemyAttack = new EnemyAttack(2, 5, "Staff",0, null, null, null, null, null);
			break;
		case BOSS:
			Logger.debug("Boss Enemy Spawn", Logger.Category.ENTITIES);
			addComponents("BossEnemy", 5);
			enemyAttack = new EnemyAttack(1, 5, "TwoHanded",0, null, null, null, null, null);
			break;
		}
