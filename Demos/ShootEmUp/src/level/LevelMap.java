...
public class LevelMap {
	...
	public LevelMap(MazeTile mazeTile) {
		...
		String file = ExtendedRenderSystem.LEVEL_FILE_LOCATION + (rand.nextInt(5) + 1) + ".map";
	...
	public void init() {
		...
		ExtendedRenderSystem.irBack = new FloorRenderer(tileMap.getBackgroundTiles(),
		...
		ExtendedRenderSystem.irWall = new WallsRenderer(walls,
				new Vector2f(ArtLoader.getImage(TILES_TEXTURE_FILE).getFWidth(),
						ArtLoader.getImage(TILES_TEXTURE_FILE).getFHeight()),
				LevelMap.TILE_WIDTH, TILE_WIDTH);
		...
		ExtendedRenderSystem.irBack.init();
		ExtendedRenderSystem.irWall.init();
	...
	public void renderLowTiles() {
		ExtendedRenderSystem.irBack.draw(ArtLoader.getImage(TILES_TEXTURE_FILE).getID());
		ExtendedRenderSystem.irWall.draw(ArtLoader.getImage(TILES_TEXTURE_FILE).getID());
	}
